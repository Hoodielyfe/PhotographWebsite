    ...
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-background border-b border-border px-4 py-3 flex items-center justify-between">
        <div>
          ...
          <span
            className={cn(
              'mt-1 inline-flex rounded-full px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.16em] shadow-sm',
              role === 'owner'
        ...
        <div className="p-4 border-t border-border">
          <div className="flex items-center gap-3 px-3 py-2 mb-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <span
                className={cn(
                  'inline-flex items-center rounded-full px-2.5 py-1 text-xs font-semibold uppercase tracking-[0.12em] shadow-sm',
                  role === 'owner'
                    ? 'bg-amber-500/10 text-amber-600'
                    : role === 'admin'
                    ? 'bg-sky-500/10 text-sky-600'
